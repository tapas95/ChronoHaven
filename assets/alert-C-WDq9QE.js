 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qc="[DEFAULT]",Ly={[jc]:"fire-core",[cy]:"fire-core-compat",[uy]:"fire-analytics",[ly]:"fire-analytics-compat",[dy]:"fire-app-check",[hy]:"fire-app-check-compat",[fy]:"fire-auth",[py]:"fire-auth-compat",[my]:"fire-rtdb",[gy]:"fire-data-connect",[_y]:"fire-rtdb-compat",[yy]:"fire-fn",[vy]:"fire-fn-compat",[Ey]:"fire-iid",[wy]:"fire-iid-compat",[Ty]:"fire-fcm",[Iy]:"fire-fcm-compat",[by]:"fire-perf",[Ay]:"fire-perf-compat",[Cy]:"fire-rc",[Ry]:"fire-rc-compat",[Sy]:"fire-gcs",[Py]:"fire-gcs-compat",[ky]:"fire-fst",[Oy]:"fire-fst-compat",[Dy]:"fire-vertex","fire-js":"fire-js",[Ny]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ro{constructor(e,t){this.shortDelay=e,this.longDelay=t,Mn(t>e,"Short delay should be less than long delay!"),this.isMobile=b_()||R_()}get(){return tv()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cf(n,e,t=!1){if(Rt(n.app))return Promise.reject(Vn(n));const r="signIn",i=await Af(n,r,e),s=await Yr._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function Xv(n,e){return Cf($n(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bl(n){const e=$n(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function BA(n,e,t){const r=$n(n);await ga(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",jv)}async function jA(n,e,t){await Fv(xe(n),{oobCode:e,newPassword:t}).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&bl(n),r})}async function qA(n,e,t){if(Rt(n.app))return Promise.reject(Vn(n));const r=$n(n),c=await ga(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Gv).catch(d=>{throw d.code==="auth/password-does-not-meet-requirements"&&bl(n),d}),l=await Yr._fromIdTokenResponse(r,"signIn",c);return await r._updateCurrentUser(l.user),l}function zA(n,e,t){return Rt(n.app)?Promise.reject(Vn(n)):Xv(xe(n),Gi.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&bl(n),r})}function Jv(n,e,t,r){return xe(n).onIdTokenChanged(e,t,r)}function Zv(n,e,t){return xe(n).beforeAuthStateChanged(e,t)}function HA(n,e,t,r){return xe(n).onAuthStateChanged(e,t,r)}function WA(n){return xe(n).signOut()}const ya="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Iw="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class bw{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(e=>e())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ba{constructor(e,t="asc"){this.field=e,this.dir=t}}function Vw(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tm=1e4,Im=`w:${lu}`,bm="FIS_v2",wb="https://firebaseinstallations.googleapis.com/v1",Tb=60*60*1e3,Ib="installations",bb="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Db=/^[cdef][\w-]{21}$/,dl="";function Ob(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=Nb(n);return Db.test(t)?t:dl}catch{return dl}}function Nb(n){return kb(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Om=new Map;function Nm(n,e){const t=tc(n);Vm(t,e),Vb(t,e)}function Vm(n,e){const t=Om.get(n);if(t)for(const r of t)r(e)}function Vb(n,e){const t=Lb();t&&t.postMessage({key:n,fid:e}),xb()}let Gr=null;function Lb(){return!Gr&&"BroadcastChannel"in self&&(Gr=new BroadcastChannel("[Firebase] FID Change"),Gr.onmessage=n=>{Vm(n.data.key,n.data.fid)}),Gr}function xb(){Om.size===0&&Gr&&(Gr.close(),Gr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hu(n){let e;const t=await nc(n.appConfig,r=>{const i=Ub(r),s=$b(n,i);return e=s.registrationPromise,s.installationEntry});return t.fid===dl?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function Ub(n){const e=n||{fid:Ob(),registrationStatus:0};return xm(e)}function $b(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(Zr.create("app-offline"));return{installationEntry:e,registrationPromise:i}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},r=Bb(n,t);return{installationEntry:t,registrationPromise:r}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:jb(n)}:{installationEntry:e}}async function Bb(n,e){try{const t=await Pb(n,e);return ka(n.appConfig,t)}catch(t){throw Am(t)&&t.customData.serverCode===409?await Lm(n.appConfig):await ka(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function jb(n){let e=await Vd(n.appConfig);for(;e.registrationStatus===1;)await Dm(100),e=await Vd(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:r}=await hu(n);return r||t}return e}function Vd(n){return nc(n,e=>{if(!e)throw Zr.create("installation-not-found");return xm(e)})}function xm(n){return qb(n)?{fid:n.fid,registrationStatus:0}:n}function qb(n){return n.registrationStatus===1&&n.registrationTime+Tm<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zb({appConfig:n,heartbeatServiceProvider:e},t){const r=Hb(n,t),i=Cb(n,t),s=e.getImmediate({optional:!0});if(s){const p=await s.getHeartbeatsHeader();p&&i.append("x-firebase-client",p)}const c={installation:{sdkVersion:Im,appId:n.appId}},l={method:"POST",headers:i,body:JSON.stringify(c)},d=await km(()=>fetch(r,l));if(d.ok){const p=await d.json();return Rm(p)}else throw await Sm("Generate Auth Token",d)}function Hb(n,{fid:e}){return`${Cm(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function du(n,e=!1){let t;const r=await nc(n.appConfig,s=>{if(!Mm(s))throw Zr.create("not-registered");const c=s.authToken;if(!e&&Gb(c))return s;if(c.requestStatus===1)return t=Wb(n,e),s;{if(!navigator.onLine)throw Zr.create("app-offline");const l=Yb(s);return t=Kb(n,l),l}});return t?await t:r.authToken}async function Wb(n,e){let t=await Ld(n.appConfig);for(;t.authToken.requestStatus===1;)await Dm(100),t=await Ld(n.appConfig);const r=t.authToken;return r.requestStatus===0?du(n,e):r}function Ld(n){return nc(n,e=>{if(!Mm(e))throw Zr.create("not-registered");const t=e.authToken;return Xb(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function Kb(n,e){try{const t=await zb(n,e),r=Object.assign(Object.assign({},e),{authToken:t});return await ka(n.appConfig,r),t}catch(t){if(Am(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await Lm(n.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await ka(n.appConfig,r)}throw t}}function Mm(n){return n!==void 0&&n.registrationStatus===2}function Gb(n){return n.requestStatus===2&&!Qb(n)}function Qb(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+Tb}function Yb(n){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:e})}function Xb(n){return n.requestStatus===1&&n.requestTime+Tm<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jb(n){const e=n,{installationEntry:t,registrationPromise:r}=await hu(e);return r?r.catch(console.error):du(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zb(n,e=!1){const t=n;return await eA(t),(await du(t,e)).token}async function eA(n){const{registrationPromise:e}=await hu(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tA(n){if(!n||!n.options)throw Fc("App Configuration");if(!n.name)throw Fc("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw Fc(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Fc(n){return Zr.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fm="installations",nA="installations-internal",rA=n=>{const e=n.getProvider("app").getImmediate(),t=tA(e),r=ni(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},iA=n=>{const e=n.getProvider("app").getImmediate(),t=ni(e,Fm).getImmediate();return{getId:()=>Jb(t),getToken:i=>Zb(t,i)}};function sA(){pn(new Xt(Fm,rA,"PUBLIC")),pn(new Xt(nA,iA,"PRIVATE"))}sA();Ft(wm,lu);Ft(wm,lu,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Da="analytics",oA="firebase_id",aA="origin",cA=60*1e3,lA="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",fu="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hA(n){if(!n.startsWith(fu)){const e=Pt.create("invalid-gtag-resource",{gtagURL:n});return wt.warn(e.message),""}return n}function Um(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function dA(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function fA(n,e){const t=dA("firebase-js-sdk-policy",{createScriptURL:hA}),r=document.createElement("script"),i=`${fu}?l=${n}&id=${e}`;r.src=t?t==null?void 0:t.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function pA(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function mA(n,e,t,r,i,s){const c=r[i];try{if(c)await e[c];else{const d=(await Um(t)).find(p=>p.measurementId===i);d&&await e[d.appId]}}catch(l){wt.error(l)}n("config",i,s)}async function gA(n,e,t,r,i){try{let s=[];if(i&&i.send_to){let c=i.send_to;Array.isArray(c)||(c=[c]);const l=await Um(t);for(const d of c){const p=l.find(T=>T.measurementId===d),y=p&&e[p.appId];if(y)s.push(y);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),n("event",r,i||{})}catch(s){wt.error(s)}}function _A(n,e,t,r){async function i(s,...c){try{if(s==="event"){const[l,d]=c;await gA(n,e,t,l,d)}else if(s==="config"){const[l,d]=c;await mA(n,e,t,r,l,d)}else if(s==="consent"){const[l,d]=c;n("consent",l,d)}else if(s==="get"){const[l,d,p]=c;n("get",l,d,p)}else if(s==="set"){const[l]=c;n("set",l)}else n(s,...c)}catch(l){wt.error(l)}}return i}function yA(n,e,t,r,i){let s=function(...c){window[r].push(arguments)};return window[i]&&typeof window[i]=="function"&&(s=window[i]),window[i]=_A(s,n,e,t),{gtagCore:s,wrappedGtag:window[i]}}function vA(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(fu)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const EA=30,wA=1e3;class TA{constructor(e={},t=wA){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const $m=new TA;function IA(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function bA(n){var e;const{appId:t,apiKey:r}=n,i={method:"GET",headers:IA(r)},s=lA.replace("{app-id}",t),c=await fetch(s,i);if(c.status!==200&&c.status!==304){let l="";try{const d=await c.json();!((e=d.error)===null||e===void 0)&&e.message&&(l=d.error.message)}catch{}throw Pt.create("config-fetch-failed",{httpStatus:c.status,responseMessage:l})}return c.json()}async function AA(n,e=$m,t){const{appId:r,apiKey:i,measurementId:s}=n.options;if(!r)throw Pt.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:r};throw Pt.create("no-api-key")}const c=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},l=new SA;return setTimeout(async()=>{l.abort()},cA),Bm({appId:r,apiKey:i,measurementId:s},c,l,e)}async function Bm(n,{throttleEndTimeMillis:e,backoffCount:t},r,i=$m){var s;const{appId:c,measurementId:l}=n;try{await CA(r,e)}catch(d){if(l)return wt.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${d==null?void 0:d.message}]`),{appId:c,measurementId:l};throw d}try{const d=await bA(n);return i.deleteThrottleMetadata(c),d}catch(d){const p=d;if(!RA(p)){if(i.deleteThrottleMetadata(c),l)return wt.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${p==null?void 0:p.message}]`),{appId:c,measurementId:l};throw d}const y=Number((s=p==null?void 0:p.customData)===null||s===void 0?void 0:s.httpStatus)===503?oh(t,i.intervalMillis,EA):oh(t,i.intervalMillis),T={throttleEndTimeMillis:Date.now()+y,backoffCount:t+1};return i.setThrottleMetadata(c,T),wt.debug(`Calling attemptFetch again in ${y} millis`),Bm(n,T,r,i)}}function CA(n,e){return new Promise((t,r)=>{const i=Math.max(e-Date.now(),0),s=setTimeout(t,i);n.addEventListener(()=>{clearTimeout(s),r(Pt.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function RA(n){if(!(n instanceof en)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class SA{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function PA(n,e,t,r,i){if(i&&i.global){n("event",t,r);return}else{const s=await e,c=Object.assign(Object.assign({},r),{send_to:s});n("event",t,c)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OA{constructor(e){this.app=e}_delete(){return delete zs[this.app.options.appId],Promise.resolve()}}let zs={},xd=[];const Md={};let Uc="dataLayer",NA="gtag",Fd,jm,Ud=!1;function VA(){const n=[];if(Yd()&&n.push("This is a browser extension environment."),k_()||n.push("Cookies are not available."),n.length>0){const e=n.map((r,i)=>`(${i+1}) ${r}`).join(" "),t=Pt.create("invalid-analytics-context",{errorInfo:e});wt.warn(t.message)}}function LA(n,e,t){VA();const r=n.options.appId;if(!r)throw Pt.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)wt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Pt.create("no-api-key");if(zs[r]!=null)throw Pt.create("already-exists",{id:r});if(!Ud){pA(Uc);const{wrappedGtag:s,gtagCore:c}=yA(zs,xd,Md,Uc,NA);jm=s,Fd=c,Ud=!0}return zs[r]=DA(n,xd,Md,e,Fd,Uc,t),new OA(n)}function xA(n=pl()){n=xe(n);const e=ni(n,Da);return e.isInitialized()?e.getImmediate():MA(n)}function MA(n,e={}){const t=ni(n,Da);if(t.isInitialized()){const i=t.getImmediate();if(mr(e,t.getOptions()))return i;throw Pt.create("already-initialized")}return t.initialize({options:e})}function FA(n,e,t,r){n=xe(n),PA(jm,zs[n.app.options.appId],e,t,r).catch(i=>wt.error(i))}const $d="@firebase/analytics",Bd="0.10.16";function UA(){pn(new Xt(Da,(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return LA(r,i,t)},"PUBLIC")),pn(new Xt("analytics-internal",n,"PRIVATE")),Ft($d,Bd),Ft($d,Bd,"esm2017");function n(e){try{const t=e.getProvider(Da).getImmediate();return{logEvent:(r,i,s)=>FA(t,r,i,s)}}catch(t){throw Pt.create("interop-component-reg-failed",{reason:t})}}}UA();const $A={apiKey:"AIzaSyBkzv8uY4HBrF19P6CUvHrSnj6xOBXACnc",authDomain:"chronohaven.firebaseapp.com",projectId:"chronohaven",storageBucket:"chronohaven.firebasestorage.app",messagingSenderId:"598935116715",appId:"1:598935116715:web:3f7801faf73ec3e72450ee",measurementId:"G-KC1GKPTGVF"},pu=nf($A),o0=lw(pu),a0=sb(pu);xA(pu);function c0(n,e="danger",t){return`
    ...
    `}export{ar as G,c0 as a,o0 as b,QA as c,a0 as d,KA as e,ib as f,ZA as g,JA as h,e0 as i,qA as j,BA as k,jA as l,n0 as m,r0 as n,i0 as o,s0 as p,YA as q,HA as r,zA as s,WA as t,t0 as u,XA as w};

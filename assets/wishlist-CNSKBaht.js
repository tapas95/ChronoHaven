import{c as v,d as p,g as f,a as g,b as m,e as b,m as y}from"./alert-DinGA58b.js";import{g as w,u as $}from"./main-De21zyoe.js";import{h as k}from"./header-Cxy6NX9S.js";import{a as x}from"./addToCart-DUa5Mo9P.js";const A=(a,o)=>{if(!(typeof a=="string"?document.querySelector(a):a))return;const d=()=>`
        <tr>
            <td colspan="4" class="p-0">
                <span class="placeholder d-block w-100 rounded-8" style="height: 6.625rem;"></span>
            </td>
        </tr>
    `;for(let r=0;r<o;r++)a.insertAdjacentHTML("beforeend",d())},h=document.getElementById("logOutBtn"),c=document.getElementById("favoriteProducts"),L=async()=>{A(c,10);const a=await w();if(a)try{const o=v(p,"users",a.uid,"favorites"),u=await f(o);if(u.empty)c&&(c.innerHTML=`
                    <tr>

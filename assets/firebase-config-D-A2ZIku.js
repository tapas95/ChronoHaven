 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Af(n,e,t=!1){if(Rt(n.app))return Promise.reject(Vn(n));const r="signIn",i=await If(n,r,e),s=await Yr._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function zv(n,e){return Af($n(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wl(n){const e=$n(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Mb(n,e,t){const r=$n(n);await fa(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",xv)}async function Fb(n,e,t){await Ov(xe(n),{oobCode:e,newPassword:t}).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&wl(n),r})}async function Ub(n,e,t){if(Rt(n.app))return Promise.reject(Vn(n));const r=$n(n),c=await fa(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",jv).catch(d=>{throw d.code==="auth/password-does-not-meet-requirements"&&wl(n),d}),l=await Yr._fromIdTokenResponse(r,"signIn",c);return await r._updateCurrentUser(l.user),l}function $b(n,e,t){return Rt(n.app)?Promise.reject(Vn(n)):zv(xe(n),Ki.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&wl(n),r})}function Wv(n,e,t,r){return xe(n).onIdTokenChanged(e,t,r)}function Kv(n,e,t){return xe(n).beforeAuthStateChanged(e,t)}function Bb(n,e,t,r){return xe(n).onAuthStateChanged(e,t,r)}function jb(n){return xe(n).signOut()}const ma="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bf{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(ma,"1"),this.storage.removeItem(ma),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xr=new Oa("@firebase/firestore");function ki(){return Xr.logLevel}function q(n,...e){if(Xr.logLevel<=he.DEBUG){const t=e.map(Al);Xr.debug(`Firestore (${Gi}): ${n}`,...t)}}function Fn(n,...e){if(Xr.logLevel<=he.ERROR){const t=e.map(Al);Xr.error(`Firestore (${Gi}): ${n}`,...t)}}function Fi(n,...e){if(Xr.logLevel<=he.WARN){const t=e.map(Al);Xr.warn(`Firestore (${Gi}): ${n}`,...t)}}function Al(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bl=-1;function Ma(n){return n==null}function _a(n){return n===0&&1/n==-1/0}function Ew(n){return typeof n=="number"&&Number.isInteger(n)&&!_a(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AT{constructor(e){this.wt=e}}function bT(n){const e=yT({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Jc(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qb(n){n=mn(n,mt);const e=mn(n.firestore,Zi);return QI(Ql(e),n._key).then(t=>gA(e,n,t))}class pm extends dA{constructor(e){super(),this.firestore=e}convertBytes(e){return new Hi(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new mt(this.firestore,null,t)}}function Yb(n){n=mn(n,Ji);const e=mn(n.firestore,Zi),t=Ql(e),r=new pm(e);return uA(n._query),YI(t,n._query).then(i=>new pA(e,r,n,i))}function Xb(n,e,t){n=mn(n,mt);const r=mn(n.firestore,Zi),i=fA(n.converter,e);return ou(r,[iA(eu(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,Yt.none())])}function Jb(n,e,t,...r){n=mn(n,mt);const i=mn(n.firestore,Zi),s=eu(i);let c;return c=typeof(e=xe(e))=="string"||e instanceof Qa?oA(s,"updateDoc",n._key,e,t,r):sA(s,"updateDoc",n._key,e),ou(i,[c.toMutation(n._key,Yt.exists(!0))])}function Zb(n){return ou(mn(n.firestore,Zi),[new Ol(n._key,Yt.none())])}function ou(n,e){return function(r,i){const s=new Ln;return r.asyncQueue.enqueueAndForget(async()=>MI(await GI(r),i,s)),s.promise}(Ql(n),e)}function gA(n,e,t){const r=t.docs.get(e._key),i=new pm(n);return new fm(n,i,e._key,r,new Ms(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(i){Gi=i})(Wi),fn(new Xt("firestore",(r,{instanceIdentifier:i,options:s})=>{const c=r.getProvider("app").getImmediate(),l=new Zi(new aw(r.getProvider("auth-internal")),new uw(c,r.getProvider("app-check-internal")),function(p,y){if(!Object.prototype.hasOwnProperty.apply(p.options,["projectId"]))throw new W(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ys(p.options.projectId,y)}(c,i),c);return s=Object.assign({useFetchStreams:t},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Ft(Nh,Vh,e),Ft(Nh,Vh,"esm2017")})();const mm="@firebase/installations",au="0.6.17";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gm=1e4,_m=`w:${au}`,ym="FIS_v2",_A="https://firebaseinstallations.googleapis.com/v1",yA=60*60*1e3,vA="installations",EA="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bA({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const r=Em(n),i=Im(n),s=e.getImmediate({optional:!0});if(s){const p=await s.getHeartbeatsHeader();p&&i.append("x-firebase-client",p)}const c={fid:t,authVersion:ym,appId:n.appId,sdkVersion:_m},l={method:"POST",headers:i,body:JSON.stringify(c)},d=await Am(()=>fetch(r,l));if(d.ok){const p=await d.json();return{fid:p.fid||t,registrationStatus:2,refreshToken:p.refreshToken,authToken:wm(p.authToken)}}else throw await Tm("Create Installation",d)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bm(n){return new Promise(e=>{setTimeout(e,n)})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CA(n){return btoa(String.fromCharCode(...n)).replace(/\+/g,"-").replace(/\//g,"_")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RA=/^[cdef][\w-]{21}$/,ll="";function SA(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=PA(n);return RA.test(t)?t:ll}catch{return ll}}function PA(n){return CA(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cm=new Map;function Rm(n,e){const t=Ja(n);Sm(t,e),kA(t,e)}function Sm(n,e){const t=Cm.get(n);if(t)for(const r of t)r(e)}function kA(n,e){const t=DA();t&&t.postMessage({key:n,fid:e}),OA()}let Gr=null;function DA(){return!Gr&&"BroadcastChannel"in self&&(Gr=new BroadcastChannel("[Firebase] FID Change"),Gr.onmessage=n=>{Sm(n.data.key,n.data.fid)}),Gr}function OA(){Cm.size===0&&Gr&&(Gr.close(),Gr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lu(n){let e;const t=await Za(n.appConfig,r=>{const i=LA(r),s=xA(n,i);return e=s.registrationPromise,s.installationEntry});return t.fid===ll?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function LA(n){const e=n||{fid:SA(),registrationStatus:0};return km(e)}function xA(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(Zr.create("app-offline"));return{installationEntry:e,registrationPromise:i}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},r=MA(n,t);return{installationEntry:t,registrationPromise:r}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:FA(n)}:{installationEntry:e}}async function MA(n,e){try{const t=await bA(n,e);return Pa(n.appConfig,t)}catch(t){throw vm(t)&&t.customData.serverCode===409?await Pm(n.appConfig):await Pa(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function FA(n){let e=await Od(n.appConfig);for(;e.registrationStatus===1;)await bm(100),e=await Od(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:r}=await lu(n);return r||t}return e}function Od(n){return Za(n,e=>{if(!e)throw Zr.create("installation-not-found");return km(e)})}function km(n){return UA(n)?{fid:n.fid,registrationStatus:0}:n}function UA(n){return n.registrationStatus===1&&n.registrationTime+gm<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $A({appConfig:n,heartbeatServiceProvider:e},t){const r=BA(n,t),i=TA(n,t),s=e.getImmediate({optional:!0});if(s){const p=await s.getHeartbeatsHeader();p&&i.append("x-firebase-client",p)}const c={installation:{sdkVersion:_m,appId:n.appId}},l={method:"POST",headers:i,body:JSON.stringify(c)},d=await Am(()=>fetch(r,l));if(d.ok){const p=await d.json();return wm(p)}else throw await Tm("Generate Auth Token",d)}function BA(n,{fid:e}){return`${Em(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uu(n,e=!1){let t;const r=await Za(n.appConfig,s=>{if(!Dm(s))throw Zr.create("not-registered");const c=s.authToken;if(!e&&HA(c))return s;if(c.requestStatus===1)return t=jA(n,e),s;{if(!navigator.onLine)throw Zr.create("app-offline");const l=WA(s);return t=qA(n,l),l}});return t?await t:r.authToken}async function jA(n,e){let t=await Nd(n.appConfig);for(;t.authToken.requestStatus===1;)await bm(100),t=await Nd(n.appConfig);const r=t.authToken;return r.requestStatus===0?uu(n,e):r}function Nd(n){return Za(n,e=>{if(!Dm(e))throw Zr.create("not-registered");const t=e.authToken;return KA(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function qA(n,e){try{const t=await $A(n,e),r=Object.assign(Object.assign({},e),{authToken:t});return await Pa(n.appConfig,r),t}catch(t){if(vm(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await Pm(n.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Pa(n.appConfig,r)}throw t}}function Dm(n){return n!==void 0&&n.registrationStatus===2}function HA(n){return n.requestStatus===2&&!zA(n)}function zA(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+yA}function WA(n){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:e})}function KA(n){return n.requestStatus===1&&n.requestTime+gm<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GA(n){const e=n,{installationEntry:t,registrationPromise:r}=await lu(e);return r?r.catch(console.error):uu(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QA(n,e=!1){const t=n;return await YA(t),(await uu(t,e)).token}async function YA(n){const{registrationPromise:e}=await lu(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Om="installations",JA="installations-internal",ZA=n=>{const e=n.getProvider("app").getImmediate(),t=XA(e),r=ni(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},eb=n=>{const e=n.getProvider("app").getImmediate(),t=ni(e,Om).getImmediate();return{getId:()=>GA(t),getToken:i=>QA(t,i)}};function tb(){fn(new Xt(Om,ZA,"PUBLIC")),fn(new Xt(JA,eb,"PRIVATE"))}tb();Ft(mm,au);Ft(mm,au,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ka="analytics",nb="firebase_id",rb="origin",ib=60*1e3,sb="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",hu="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ab(n){if(!n.startsWith(hu)){const e=Pt.create("invalid-gtag-resource",{gtagURL:n});return wt.warn(e.message),""}return n}function Nm(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function cb(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function lb(n,e){const t=cb("firebase-js-sdk-policy",{createScriptURL:ab}),r=document.createElement("script"),i=`${hu}?l=${n}&id=${e}`;r.src=t?t==null?void 0:t.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function ub(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function hb(n,e,t,r,i,s){const c=r[i];try{if(c)await e[c];else{const d=(await Nm(t)).find(p=>p.measurementId===i);d&&await e[d.appId]}}catch(l){wt.error(l)}n("config",i,s)}async function db(n,e,t,r,i){try{let s=[];if(i&&i.send_to){let c=i.send_to;Array.isArray(c)||(c=[c]);const l=await Nm(t);for(const d of c){const p=l.find(T=>T.measurementId===d),y=p&&e[p.appId];if(y)s.push(y);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),n("event",r,i||{})}catch(s){wt.error(s)}}function fb(n,e,t,r){async function i(s,...c){try{if(s==="event"){const[l,d]=c;await db(n,e,t,l,d)}else if(s==="config"){const[l,d]=c;await hb(n,e,t,r,l,d)}else if(s==="consent"){const[l,d]=c;n("consent",l,d)}else if(s==="get"){const[l,d,p]=c;n("get",l,d,p)}else if(s==="set"){const[l]=c;n("set",l)}else n(s,...c)}catch(l){wt.error(l)}}return i}function pb(n,e,t,r,i){let s=function(...c){window[r].push(arguments)};return window[i]&&typeof window[i]=="function"&&(s=window[i]),window[i]=fb(s,n,e,t),{gtagCore:s,wrappedGtag:window[i]}}function mb(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(hu)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gb=30,_b=1e3;class yb{constructor(e={},t=_b){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const Vm=new yb;function vb(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function Eb(n){var e;const{appId:t,apiKey:r}=n,i={method:"GET",headers:vb(r)},s=sb.replace("{app-id}",t),c=await fetch(s,i);if(c.status!==200&&c.status!==304){let l="";try{const d=await c.json();!((e=d.error)===null||e===void 0)&&e.message&&(l=d.error.message)}catch{}throw Pt.create("config-fetch-failed",{httpStatus:c.status,responseMessage:l})}return c.json()}async function wb(n,e=Vm,t){const{appId:r,apiKey:i,measurementId:s}=n.options;if(!r)throw Pt.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:r};throw Pt.create("no-api-key")}const c=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},l=new Ab;return setTimeout(async()=>{l.abort()},ib),Lm({appId:r,apiKey:i,measurementId:s},c,l,e)}async function Lm(n,{throttleEndTimeMillis:e,backoffCount:t},r,i=Vm){var s;const{appId:c,measurementId:l}=n;try{await Tb(r,e)}catch(d){if(l)return wt.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${d==null?void 0:d.message}]`),{appId:c,measurementId:l};throw d}try{const d=await Eb(n);return i.deleteThrottleMetadata(c),d}catch(d){const p=d;if(!Ib(p)){if(i.deleteThrottleMetadata(c),l)return wt.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${p==null?void 0:p.message}]`),{appId:c,measurementId:l};throw d}const y=Number((s=p==null?void 0:p.customData)===null||s===void 0?void 0:s.httpStatus)===503?ih(t,i.intervalMillis,gb):ih(t,i.intervalMillis),T={throttleEndTimeMillis:Date.now()+y,backoffCount:t+1};return i.setThrottleMetadata(c,T),wt.debug(`Calling attemptFetch again in ${y} millis`),Lm(n,T,r,i)}}function Tb(n,e){return new Promise((t,r)=>{const i=Math.max(e-Date.now(),0),s=setTimeout(t,i);n.addEventListener(()=>{clearTimeout(s),r(Pt.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function Ib(n){if(!(n instanceof Zt)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class Ab{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function bb(n,e,t,r,i){if(i&&i.global){n("event",t,r);return}else{const s=await e,c=Object.assign(Object.assign({},r),{send_to:s});n("event",t,c)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sb{constructor(e){this.app=e}_delete(){return delete Hs[this.app.options.appId],Promise.resolve()}}let Hs={},Vd=[];const Ld={};let xc="dataLayer",Pb="gtag",xd,xm,Md=!1;function kb(){const n=[];if(Gd()&&n.push("This is a browser extension environment."),A_()||n.push("Cookies are not available."),n.length>0){const e=n.map((r,i)=>`(${i+1}) ${r}`).join(" "),t=Pt.create("invalid-analytics-context",{errorInfo:e});wt.warn(t.message)}}function Db(n,e,t){kb();const r=n.options.appId;if(!r)throw Pt.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)wt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Pt.create("no-api-key");if(Hs[r]!=null)throw Pt.create("already-exists",{id:r});if(!Md){ub(xc);const{wrappedGtag:s,gtagCore:c}=pb(Hs,Vd,Ld,xc,Pb);xm=s,xd=c,Md=!0}return Hs[r]=Rb(n,Vd,Ld,e,xd,xc,t),new Sb(n)}function Ob(n=hl()){n=xe(n);const e=ni(n,ka);return e.isInitialized()?e.getImmediate():Nb(n)}function Nb(n,e={}){const t=ni(n,ka);if(t.isInitialized()){const i=t.getImmediate();if(mr(e,t.getOptions()))return i;throw Pt.create("already-initialized")}return t.initialize({options:e})}function Vb(n,e,t,r){n=xe(n),bb(xm,Hs[n.app.options.appId],e,t,r).catch(i=>wt.error(i))}const Fd="@firebase/analytics",Ud="0.10.16";function Lb(){fn(new Xt(ka,(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return Db(r,i,t)},"PUBLIC")),fn(new Xt("analytics-internal",n,"PRIVATE")),Ft(Fd,Ud),Ft(Fd,Ud,"esm2017");function n(e){try{const t=e.getProvider(ka).getImmediate();return{logEvent:(r,i,s)=>Vb(t,r,i,s)}}catch(t){throw Pt.create("interop-component-reg-failed",{reason:t})}}}Lb();const xb={apiKey:"AIzaSyBkzv8uY4HBrF19P6CUvHrSnj6xOBXACnc",authDomain:"chronohaven.firebaseapp.com",projectId:"chronohaven",storageBucket:"chronohaven.firebasestorage.app",messagingSenderId:"598935116715",appId:"1:598935116715:web:3f7801faf73ec3e72450ee",measurementId:"G-KC1GKPTGVF"},du=ef(xb),e0=rw(du),t0=ZI(du);Ob(du);export{ar as G,e0 as a,qb as b,zb as c,t0 as d,Ub as e,Xb as f,Yb as g,Wb as h,Mb as i,Fb as j,Qb as k,Zb as l,jb as m,Bb as o,Kb as q,$b as s,Jb as u,Gb as w};

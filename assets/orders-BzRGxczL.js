import{c as p,d as u,q as m,w as b,g,a as h}from"./alert-DWjb4CXO.js";import{h as y,g as f}from"./header-C8m5pGcf.js";const w=(t,d)=>{if(!(typeof t=="string"?document.querySelector(t):t))return;const n=()=>`
        <tr>
            <td colspan="6" class="p-0">
                <span class="placeholder d-block w-100 rounded-8" style="height: 3.25rem;"></span>
            </td>
        </tr>
    `;for(let r=0;r<d;r++)t.insertAdjacentHTML("beforeend",n())},i=document.getElementById("logOutBtn"),o=document.getElementById("orderedProducts"),v=async()=>{w(o,10);const t=await f();if(t)try{const d=p(u,"orders"),c=m(d,b("userId","==",t.uid)),n=await g(c);n.empty?o&&(o.innerHTML=`
                    <tr>
                ...
                `):(o.innerHTML="",n.forEach(r=>{const e=r.data(),s=r.id,a=e.createdAt.toDate(),l=a?a.toLocaleDateString("en-IN",{year:"numeric",month:"short",day:"numeric"}):"N/A";o&&o.insertAdjacentHTML("beforeend",`
                        ...
                        `)}),requestAnimationFrame(()=>{document.querySelectorAll(".view-order").forEach(e=>{const s=e.getAttribute("data-order-id");e.addEventListener("click",a=>{a.preventDefault(),window.location.href=`./order-details.html?orderId=${s}`})})}))}catch(d){console.log(d)}};v();i&&i.addEventListener("click",t=>{t.preventDefault(),y()});

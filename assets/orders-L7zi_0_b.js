import{c as p,d as m,q as u,w as b,g,a as h}from"./alert-DinGA58b.js";import{g as y}from"./main-De21zyoe.js";import{h as f}from"./header-Cxy6NX9S.js";const w=(t,d)=>{if(!(typeof t=="string"?document.querySelector(t):t))return;const n=()=>`
        <tr>
    ...
    `;for(let r=0;r<d;r++)t.insertAdjacentHTML("beforeend",n())},i=document.getElementById("logOutBtn"),o=document.getElementById("orderedProducts"),v=async()=>{w(o,10);const t=await y();if(t)try{const d=p(m,"orders"),c=u(d,b("userId","==",t.uid)),n=await g(c);n.empty?o&&(o.innerHTML=`
                ...
                `):(o.innerHTML="",n.forEach(r=>{const e=r.data(),s=r.id,a=e.createdAt.toDate(),l=a?a.toLocaleDateString("en-IN",{year:"numeric",month:"short",day:"numeric"}):"N/A";o&&o.insertAdjacentHTML("beforeend",`
                        ...
                        `)}),requestAnimationFrame(()=>{document.querySelectorAll(".view-order").forEach(e=>{const s=e.getAttribute("data-order-id");e.addEventListener("click",a=>{a.preventDefault(),window.location.href=`./order-details.html?orderId=${s}`})})}))}catch(d){console.log(d)}};v();i&&i.addEventListener("click",t=>{t.preventDefault(),f()});

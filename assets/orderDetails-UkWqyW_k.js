                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center gap-3 mb-2">
                                ...
                                <p class="d-flex align-items-center gap-2 fs-sm lh-1 fw-medium">
                                    ...
                                    <span class="variant d-block rounded-circle" style="background-image: linear-gradient( -45deg, ${e.variant.map(b=>e.variant.length>1?`${b} ${100/e.variant.length}`:`${b}`).join(", ")} )"></span>
                                </p>
                            </div>
                            <p class="d-flex align-items-center gap-2 fs-sm lh-1 fw-medium">
